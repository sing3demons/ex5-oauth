...
func (l *Logger) Detail(level LogLevel, actionInfo ActionInfo, data interface{}, maskingRules ...MaskingRule) {
...
func (l *Logger) Summary(level LogLevel, actionInfo ActionInfo, summary map[string]interface{}) {
	log := DetailLog{
		Level:             level,
		Type:              TypeSummary,
		Action:            actionInfo.Action,
...
func (l *Logger) InfoDetail(actionInfo ActionInfo, data interface{}, maskingRules ...MaskingRule) {
	l.Detail(LevelInfo, actionInfo, data, maskingRules...)
}

func (l *Logger) DebugDetail(actionInfo ActionInfo, data interface{}, maskingRules ...MaskingRule) {
	l.Detail(LevelDebug, actionInfo, data, maskingRules...)
}

func (l *Logger) WarnDetail(actionInfo ActionInfo, data interface{}, maskingRules ...MaskingRule) {
	l.Detail(LevelWarn, actionInfo, data, maskingRules...)
}

func (l *Logger) ErrorDetail(actionInfo ActionInfo, data interface{}, maskingRules ...MaskingRule) {
	l.Detail(LevelError, actionInfo, data, maskingRules...)
}

func (l *Logger) InfoSummary(actionInfo ActionInfo, summary map[string]interface{}) {
	l.Summary(LevelInfo, actionInfo, summary)
}

func (l *Logger) ErrorSummary(actionInfo ActionInfo, summary map[string]interface{}) {
